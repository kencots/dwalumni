      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link font-weight-bold px-3" href="#">About</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link font-weight-bold px-3" href="#">Sign In</a>
            </li>
            <li class="nav-item ">
              <a class="nav-link bg-primary font-weight-bold text-white px-4" href="#">Sign Up</a>
            </li>
          </ul> 
        </div>
      </div>
