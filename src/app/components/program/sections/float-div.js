				      	...
				      	<div className="row " >
					        ...
					        <div className="col-md-4 col-sm-12 col-xs-12">
					            <div className="container">
					                <div className=" row justify-content-center">
					                	<div className="col-md-4 col-12">
					                 		<p className="primary-icon text-center text-md-left"><i className="fas fa-briefcase"></i></p>
					              		</div>
					             		<div >
					                		<p ><h3 className="text-highlight-bold text-center text-md-left">78%</h3></p>
					                		<p className="text-center text-md-left">Lorem Ipsum adalah contoh</p>
					              		</div>
					            	</div>
					          	</div>
					        ...
					        <div className="col-md-4 col-sm-12 col-xs-12">
					            <div className="container">
					                <div className=" row justify-content-center">
					                	<div className="col-md-4 col-12">
					                 		<p className="primary-icon text-center text-md-left"><i className="fas fa-donate"></i></p>
					              		</div>
					             		<div >
					                		<p ><h3 className="text-highlight-bold text-center text-md-left">IDR 8 jt</h3></p>
					                		<p className="text-center text-md-left">Lorem Ipsum adalah contoh</p>
					              		</div>
					            	</div>
					          	</div>
